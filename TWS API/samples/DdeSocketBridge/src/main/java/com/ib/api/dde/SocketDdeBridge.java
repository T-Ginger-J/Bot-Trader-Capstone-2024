...
public class SocketDdeBridge {
    ...
    public SocketDdeBridge(String ddeServiceName, String twsHost, int twsPort, int twsClientId, String connectOptions) {
        ...
        m_twsService = new TwsService(twsHost, twsPort, twsClientId, connectOptions,
