...
public class MainFrame extends JFrame {
    ...
    public void start(String ddeServiceName, String host, int port, int clientId, String connectOptions) {
        ...
        SocketDdeBridge bridge = new SocketDdeBridge(ddeServiceName, host, port, clientId, connectOptions);
