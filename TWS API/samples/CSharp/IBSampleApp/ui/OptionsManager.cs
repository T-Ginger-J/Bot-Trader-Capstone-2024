...
namespace IBSampleApp.ui
{
    class OptionsManager
    {
        ...
        public void ExerciseOptions(int ovrd, int quantity, string exchange, int action, string manualOrderTime, string customerAccount, bool professionalCustomer) 
        {
            if (positionsGrid.SelectedRows.Count > 0 )
            {
                ...
                ibClient.ClientSocket.exerciseOptions(currentOptionsExercisingRequest, contract, action, quantity, account, ovrd, manualOrderTime, customerAccount, professionalCustomer);
            }
        }
