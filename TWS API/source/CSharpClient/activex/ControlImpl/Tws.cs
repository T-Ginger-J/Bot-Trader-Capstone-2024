...
namespace TWSLib
{
    ...
    public class Tws : EWrapper, ITws, IDisposable
    {
        ...
        public delegate void permIdDelegate(int id, long permId);
        ...
        public delegate void orderStatusDelegate(int id, string status, object filled, object remaining, double avgFillPrice, long permId, int parentId, double lastFillPrice, int clientId, string whyHeld, double mktCapPrice);
        ...
        public delegate void OrderBoundDelegate(long permId, int clientId, int orderId);
        ...
        void EWrapper.orderBound(long permId, int clientId, int orderId)
        {
            ...
            if (tmp != null)
                sc.Post(state => tmp(permId, clientId, orderId), null);
        }
