...
namespace TWSLib
{
    ...
    public interface ITwsEvents
    {
        ...
        [DispId(10)]
        void permId(int id, long permId);
        [DispId(12)]
        ...
        [DispId(13)]
        void orderStatus(int id, string status, object filled, object remaining, double avgFillPrice, long permId, int parentId, double lastFillPrice, int clientId, string whyHeld, double mktCapPrice);
        [DispId(14)]
